        ...
        <section className={styles.about} id='about'>
            <Container>
                <div className={styles.wrapper}>
                    ...
                    <p className={styles.text2}>З нашою допомогою ви зможете отримати необхідну інформацію по всім питанням, пов`язаним з отриманням сертифікатів та інших дозвільних документів для ввозу та реалізації продукції на території України.</p>
                </div>
            </Container>
        </section>
    );
